...
_WORKER_ROUND = {
    ...
    **_phases(),
    "bytes_up": {**_INT0, "description": "raw payload bytes worker→coordinator"},
    "bytes_down": {**_INT0, "description": "raw payload bytes coordinator→worker"},
    "wire_bytes_up": {**_INT0, "description": "encoded (base64) bytes on the sealed relay, worker→coordinator"},
    "wire_bytes_down": {**_INT0, "description": "encoded (base64) bytes on the sealed relay, coordinator→worker"},
    "samples": _INT0,
...
_ROUND = {
    **_header("round"),
    ...
    "hook_s": {**_SECS, "description": "after-outer-step hook (e.g. EMA update + collapse monitors), included in workers' wait_s"},
    "eval_s": {**_SECS, "description": "periodic evaluation time, included in workers' wait_s"},
